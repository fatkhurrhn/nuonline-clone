...
function p() {
    ...
    document.body.addEventListener("focusin", n => {
        ...
        for (const n of document.getElementsByTagName("a")) c.has(n) || i(n, "hover") && (c.add(n), n.addEventListener("mouseenter", t, {
            passive: !0
...
function w() {
    let e;
    u(() => {
        for (const t of document.getElementsByTagName("a")) c.has(t) || i(t, "viewport") && (c.add(t), e ? ? = y(), e.observe(t))
    })
}
...
function y() {
    ...
    return new IntersectionObserver((t, o) => {
        for (const n of t) {
            const r = n.target,
                a = e.get(r);
            n.isIntersecting ? (a && clearTimeout(a), e.set(r, setTimeout(() => {
...
function S(e, t) {
    ...
    try {
        ...
        return location.origin === o.origin && (location.pathname !== o.pathname || location.search !== o.search) && !d.has(e)
    } catch { }
    return !1
}
...
function i(e, t) {
    ...
    return o === "false" ? !1 : t === "tap" && (o != null || f) && m() ? !0 : o == null && f || o === "" ? t === h : o === t
}
